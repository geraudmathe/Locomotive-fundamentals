...
![General Information](Locomotive-fundamentals/images/page_general_info.png)
...
![SEO settings](Locomotive-fundamentals/images/page_seo_settings.png)
...
![Advanced options](Locomotive-fundamentals/images/page_advanced_options.png)
...
![RSS page](Locomotive-fundamentals/images/page_rss.png)
...
![Create model](Locomotive-fundamentals/images/models_basics_creation.png)
...
![Create fields](Locomotive-fundamentals/images/models_basics_fields.png)
...
![Types list](Locomotive-fundamentals/images/models_basics_types_list.png)
...
- Text :
  ...
  ![type text 1](Locomotive-fundamentals/images/models_basics_text_1.png)

  you then have a properties panel which appears by clicking on the arrow on the right part of the line :

  ![type text 2](Locomotive-fundamentals/images/models_basics_text_2.png)

  If you choose ```Text formatting : HTML```, you will have a WYSIWYG editor, TinyMCE :

  ![type text tinymce](Locomotive-fundamentals/images/models_basics_text_tinymce.png)

   And if you choose ```Text formatting : none```, you will have a simple textarea :

   ![type text textarea](Locomotive-fundamentals/images/models_basics_text_textarea.png)

- Select :

  Displays a select list of options for the field.

  ![type select](Locomotive-fundamentals/images/models_basics_select.png)
...
- Date :
  ...
  ![type date](Locomotive-fundamentals/images/models_basics_date.png)
...
![type properties](Locomotive-fundamentals/images/models_basics_properties.png)
...
![models advanced props](Locomotive-fundamentals/images/models_basics_advanced.png)

For the purpose of the example, the following model will be used in what's follow :


![models advanced model](Locomotive-fundamentals/images/models_basics_advanced_model.png)
...
- Label field :
  ...
  ![models advanced label 1](Locomotive-fundamentals/images/models_basics_advanced_label1.png)


  And if you choose ```publishing_date```, you end up with :

  ![models advanced label 2](Locomotive-fundamentals/images/models_basics_advanced_label2.png)
...
- Group by field :
  ...
  ![models advanced group by](Locomotive-fundamentals/images/models_basics_advanced_groupby.png)
...
- Item template :
  ...
  ![models advanced item template](Locomotive-fundamentals/images/models_basics_advanced_itemtemplate.png)

  And my entries would display this way :

  ![models advanced item template1](Locomotive-fundamentals/images/models_basics_advanced_itemtemplate1.png)
...
![authors](Locomotive-fundamentals/images/belongsto_authors.png)

The mapping with the model ```books``` will be defined in ```books```.
Let's create ```books```:

![books step 1](Locomotive-fundamentals/images/belongsto_books_1.png)
...
![books arrow](Locomotive-fundamentals/images/belongsto_arrow.png)

You then have the option panel where you choose the ```Class name``` of the model targeted by the belongs_to relationship :

![books step 2](Locomotive-fundamentals/images/belongsto_books_2.png)
...
![books entrie empty](Locomotive-fundamentals/images/belongsto_book_entrie_empty.png)

We can give him a name, but the ```writer``` list is empty, right, because ```authors``` model hasn't any entries yet.

So create an author :

![author add](Locomotive-fundamentals/images/belongsto_author_entrie.png)

And then go back in the book creation page, the author appears in the ```writer``` list :

![book entrie valid](Locomotive-fundamentals/images/belongsto_book_entrie_valid.png)
...
![book reviews](Locomotive-fundamentals/images/hasmany_reviews.png)

**The ```belongs_to``` field targeting the parent model class name, ```books```, is required !**

![book reviews belongs to field](Locomotive-fundamentals/images/hasmany_reviews_belongsfield.png)
...
![book editing](Locomotive-fundamentals/images/hasmany_books.png)
...
![book entrie](Locomotive-fundamentals/images/hasmany_bookentrie_1.png)

Let's add a review to this book, click on "Add a new entry" and fill it with dummy text :

![book entrie reviewed](Locomotive-fundamentals/images/hasmany_bookentrie_2.png)
...
![tips ui enable](Locomotive-fundamentals/images/models_tips_uienable.png)
...
![tags creation 1](Locomotive-fundamentals/images/manytomany_tags_1.png)
![tags creation 2](Locomotive-fundamentals/images/manytomany_tags_2.png)
...
![books m2m update](Locomotive-fundamentals/images/manytomany_books.png)
...
![tags inverse of update](Locomotive-fundamentals/images/manytomany_tags_inverseof.png)
...
![m2m enable ui problem](Locomotive-fundamentals/images/manytomany_enableui.png)

We have to create a new tag entry separately, and then add it when editing the book entry. So we do :

![m2m tag available in book](Locomotive-fundamentals/images/manytomany_tag_entrie.png)
...
![m2m tag available in book](Locomotive-fundamentals/images/manytomany_books_tags_available.png)
...
![entries attributes](Locomotive-fundamentals/images/entries_attributes.png)
...
![paginate attributes](Locomotive-fundamentals/images/paginate_object.png)
...
![paginate filter](Locomotive-fundamentals/images/paginate_filter.png)
...
![templatized page archi](Locomotive-fundamentals/images/templatize_archi.png)
...
- **posts** page :
  ...
  ![templatized page posts](Locomotive-fundamentals/images/templatize_posts1.png)

  ![templatized page posts 2](Locomotive-fundamentals/images/templatize_posts2.png)
  ...
  ![templatized page posts liquid](Locomotive-fundamentals/images/templatize_posts_liquid.png)
...
- **template** page :
  ...
  ![templatized page 1](Locomotive-fundamentals/images/templatize_template1.png)

  You set the page **posts** as the *parent* of this one. A templatized page **must** have a *parent*, other than index.

  ![templatized page 2](Locomotive-fundamentals/images/templatize_template2.png)
  ...
  ![templatized page template liquid](Locomotive-fundamentals/images/templatize_template_liquid.png)
...
![internationalization panel](Locomotive-fundamentals/images/internationalization_1.png)
...
![internationalization locale switcher](Locomotive-fundamentals/images/internationalization_2.png)
...
![internationalizationeng page](Locomotive-fundamentals/images/internationalization_untranslated.png)
...
![internationalization model](Locomotive-fundamentals/images/internationalization_model.png)
...
![internationalization locales](Locomotive-fundamentals/images/internationalization_locales.png)
